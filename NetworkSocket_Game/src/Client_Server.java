...
public class Client_Server extends Thread {
	...
	private void help()
	{
		// 만약 사용자가 도움말 버튼을 클릭하면 도움말을 보여주기 위한 메소드입니다.
		new Help().setVisible(true);
	}
	public static void ExitGameSignal()
	/*
	 * 게임 클래스로부터 게임종료 메시지를 받기위한 메소드입니다.
	 */
	{
