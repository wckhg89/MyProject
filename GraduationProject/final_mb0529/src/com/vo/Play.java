...
public class Play {
	 ...
	 * @param p_img
	 */
	public Play(int p_num, String p_m_id, String p_img, String p_content, String p_date, String p_location2, String p_session, String p_location) {
		this.p_num = p_num;
		this.p_m_id = p_m_id;
		this.p_img = p_img;
	...
	public Play(String p_m_id, String p_img, int p_price, String p_session, String p_inout, String p_content
			,String p_location, String p_location2){
		this.p_m_id = p_m_id;
		this.p_img = p_img;
