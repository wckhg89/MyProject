...
<script type="text/javascript">
	(function($) {
		...
		var func = {
			...
			isClosed : function(target) {//현재 메뉴바가 열린건지 닫힌건지 확인
	...
	<div id="wrap">
		...
		<div id="leftMenu" class="sidemenu sidemenu-left"
			...
			<div class="list-group">
				<a href="#" class="list-group-item active">회원가입</a> <a href="#"
					class="list-group-item">로그인</a> <a href="#" class="list-group-item">글작성</a>
			...
			<center>
				<div id='section_article'>
					<table>
						<tr>
							...
							<td>
								<p class='section_font'>작성일 : ${play_Bean.p_date }</p>
								<p class='section_font'>작성자 : ${play_Bean.p_m_id }</p>
								<p class='section_font'>내 용 : ${play_Bean.p_content }</p>
								<p class='section_font'>위 치 : ${play_Bean.p_location2 }</p>
								<p class='section_font'>가격정보 : ${play_Bean.p_price }</p>
								<p class='section_font'>추천계절 : ${play_Bean.p_session }</p>
								<p class='section_font'>실내외여부 : ${play_Bean.p_inout }</p>
							</td>
						</tr>
					</table>
				</div>
				<div id='section_article2'>
					...
					<table background="white">
						<tr>
							<td><p class='section_font'>추천 수 : ${play_Bean.p_l_count }</p></td>
							<td><p class='section_font'>댓글 수 : ${play_Bean.p_r_count }</p></td>
						</tr>
