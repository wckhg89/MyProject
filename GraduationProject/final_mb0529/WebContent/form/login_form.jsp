	...
	<div id="wrap">
		...
		<div id="leftMenu" class="sidemenu sidemenu-left" style="padding:10px; width:200px;">
            ...
            <div class="list-group">
                <a href="join_form.jsp" class="list-group-item active">회원가입</a>
                <a href="login_form.jsp" class="list-group-item">로그인</a>
                <a href="write_form.jsp" class="list-group-item">글작성</a>
                <a href="recommend.jsp" class="list-group-item">추천 </a>
		...
		<form role="form" id="f" method="post">
			...
			<img src="img/login.png"><br><br>
				<table align="center">
					...
					<tr>
						<div>
							<td align="left"><input class="btn btn-primary btn-sidemenu" id="join" type="button"
									onclick="goJoin()" value="Join"></td>
							<td align="right"><input class="btn btn-primary btn-sidemenu" id="login" type="button"
