...
<script>
   function goSearch() {
      var form = document.getElementById("n_form");
      form.action = "noticeSearch.do";
      form.submit();
   }
   function goWrite() {
      var form = document.getElementById("n_form");
      form.action = "noticeNew.do";
      form.submit();
   }
</script>
</head>
<body>
   ...
   <div id="content">
      <c:set var="n_list" value="${requestScope.n_list }" />
      <center>
         ...
         <table summary="list" align="center" class="table table-hover"
            ...
            <div class="form-group">
               ...
               <tbody>
                  <c:forEach items="${n_list}" var="n" varStatus="status">
                     <tr class="table_body" align="center">
                        ...
                        <td><img src="img/micon.png"/> 관리자</td>
                        <td>${n.n_date}</td>
                        <td>${n.n_count}</td>
                     </tr>
                  </c:forEach>
