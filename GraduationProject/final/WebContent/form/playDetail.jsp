...
<body onload="initTmap()">
	...
	<div id="content">
		<c:set var="p_d" value="${requestScope.playList }" />
		<c:set var="p_r_d" value="${requestScope.playRList }" />
		<c:set var="p_l_d" value="${requestScope.playLList }" />
		<script>
								var visible2 = false;
		...
		<table>
				...
				<td align="center">
					<table>
						<tr>
							<td>
								...
								<div id="likeMember">
									<table>
										...
										<tr>
											<c:forEach items="${p_l_d}" var="pld">
												<td align='center'><img src="files/${pld.m_img }"
													class="like_pic"> <br>
													<p class='like_font'>${pld.p_l_m_id }</p></td>
											</c:forEach>
										</tr>
									</table>
								</div>
							...
							<td style="width: 100px;"></td>
							<td><p class='section_font'>댓글 수 : ${p_d.p_r_count }</p></td>
						</tr>
					</table>
				</td>
				<td style="width: 100px;"></td>
			...
			<tr>
				<td>
					<div class="info_div">
						<table>
						<c:forEach items="${p_r_d}" var="prd">
							<tr>
							<td>						
							<img src="files/${prd.m_img}" class="member_pic">
							</td>
							<td>
							${prd.p_r_m_id }
							${prd.p_r_content }
					...
					<div class="info_div">
						...
						<table>
							...
							<tr>
								...
								<a onclick="memberDetail()"><img src="img/idicon3.png"/></a>&nbsp;${p_d.p_m_id }
								<div id="submenu">
									<div>
										<a href="memberDetail.do?m_id=${p_d.p_m_id }">회원정보</a>
									</div>
									<div>
										<a href="meet_friend.do?f_id=${p_d.p_m_id }">친구맺기</a>
									</div>
								</div>
						...
						<table align="center">
							...
							<tr>
								<td align="center">${p_d.p_price}만원대</td>
								<td align="center">${p_d.p_session}</td>
								<td align="center">${p_d.p_inout}</td>
							</tr>
						</table>
					</div>
				</td>
			...
			<tr>
				<td align="center">
				<form id='like_btn' method='post' action='enterReply.do'>
					<input type="hidden" name="id" value="${p_d.p_m_id}">
						...
						<input type="textarea" name='content_Rply' style="width: 330px; text-align: center"><input
							type='submit'>
					</form>
				</td>
				<td style="width: 100px;"></td>
		...
		<div class="content_div" align="center">${p_d.p_content}</div>
